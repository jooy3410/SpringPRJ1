...
<!--메인 로고 자리-->
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active"><a href="/safe/main.do" class="nav-link">Home</a></li>
          <li class="nav-item"><a href="about.html" class="nav-link">안심식당</a></li>
          <li class="nav-item"><a href="course.html" class="nav-link">전체지도</a></li>
          <li class="nav-item"><a href="teacher.html" class="nav-link">마이페이지</a></li>
